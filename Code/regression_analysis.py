...
indeed just MAE, however similarity_score reads more
...
tuned_keras_regressor = load_model('Project3/tuned_regressor.keras')
...
booster.load_model('Project3/tuned_xgboost.json')
